...
<html lang="en">
    ...
    <body style="background-image: url(images/bg2.jpg); opacity: 5; position: absolute; height: 100%; width: 100%; ">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="topFixedNavbar1">
                 ...
                 <ul class="nav navbar-nav navbar-right text-uppercase">
                  ...
                  <li><a href="SearchHotels.jsp" onmousemove="HideModalWindow()">Search Hotels</a></li>
