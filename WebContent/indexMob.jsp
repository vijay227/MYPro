...
<script src="JavaScript/newjavascript.js" type="text/javascript"></script>
  ...
  <section class="container section" id="contact">
    ...
    String to_add = "ndundyar2177@gmail.com", subject = sub, messageText = msg1, password = "Nitesh@2177";
...
%>
		...
		<div class="col-md-6 contact-info">
			...
			<p><strong class="text-uppercase">Phone :</strong>9822077919 / 9890239863 </p>
			<p><strong class="text-uppercase">Address :</strong>Sinhgad College of Engg. Vadgaon, Pune</p>
		</div>
	</div>
  </section>
